...
<div class="page">
       <div class="navbar">
           <img src="Images/newspaperlogo.jpeg" class="logo">
           <h1>Rahul<span style="font-family: 'Merienda', cursive;
            color:rgb(20, 76, 80);">NEWSPAPER</span></h1>
           <nav>
               <ul>
       ...
       <div class="row">
        <div class="col-1">
             <img src="Images/newspaper2.jpeg" >
        </div> 
        <div class="col-2">
